...
/home/ubuntu/google-cloud-sdk/bin/bq load --field_delimiter=',' --source_format=CSV --skip_leading_rows=1 --max_bad_records=0  --allow_jagged_rows=1 --allow_quoted_newlines=1 --ignore_unknown_values=1  Atom_rt.order_line_temp gs://nb_rt/olExport.csv /home/ubuntu/RT/schema_order_line.json
...
/home/ubuntu/google-cloud-sdk/bin/bq query --allow_large_results=1 --destination_table=Atom_rt.order_header_final 'select * from Atom_rt.order_header where orderid not in (select orderid from Atom_rt.order_header_temp)' > /dev/null
...
/home/ubuntu/google-cloud-sdk/bin/bq query --allow_large_results=1 --destination_table=Atom_rt.order_line_final 'select * from Atom_rt.order_line where orderlineid not in (select orderlineid from Atom_rt.order_line_temp)' > /dev/null
/home/ubuntu/google-cloud-sdk/bin/bq query --append=1 --allow_large_results=1 --destination_table=Atom_rt.order_line_final 'select * from Atom_rt.order_line_temp' > /dev/null
/home/ubuntu/google-cloud-sdk/bin/bq rm -f Atom_rt.order_line
/home/ubuntu/google-cloud-sdk/bin/bq cp Atom_rt.order_line_final Atom_rt.order_line
/home/ubuntu/google-cloud-sdk/bin/bq rm -f Atom_rt.order_line_final
/home/ubuntu/google-cloud-sdk/bin/bq rm -f Atom_rt.order_line_temp
