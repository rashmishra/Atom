...
## Script Name: export_apps_flyer.sh
## Purpose: Modular ETL flow of Atom.

##### $1: Data Object. ####
##### $2: Data dump apps_flyer. ####
...
v_logs_dir=$5/logs;
v_arch_dir=$5/arch;
v_extract_scripts_dir=$5/export_scripts;
...
./mongoexport --host 10.2.4.25:27017 --db shylock -c apps_flyer --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
...
#echo "apps_flyer mongo export end time is : $taskEndTime "
