...
cd $v_mongo_dir
./mongoexport --host 10.2.4.65:27017 --db nb-blackpearl -c bpdeals -q '{isPublished:true,isDeleted:false}' --out $v_data_dump_dir/$v_data_object.json &
v_extract_pid=$!
...
#echo "bpdeal mongo export end time is : $taskEndTime "
