...
## Script Name: export_bravo_top_brands.sh
...
p_exit_upon_error(){
    ...
    then
        ...
        # Creating new file for bravo_top_brands's ETL run. Content will be appended in further tasks of T and L.
...
#echo "bravo_top_brands mongo export end time is : $taskEndTime "
