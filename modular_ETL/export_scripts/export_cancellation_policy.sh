...
cd $v_mongo_dir
./mongoexport --host 10.2.1.242:27017 --db nb-lookup -c cancellationpolicy --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
