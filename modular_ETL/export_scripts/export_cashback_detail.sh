...
## Script Name: export_cashback_detail.sh
...
v_command="\copy (select * from oms_data.cashbackdetail where createdat>$v_incremental_epoch or updatedat>$v_incremental_epoch)  to $v_extract_filename with DELIMITER ',' CSV HEADER"
