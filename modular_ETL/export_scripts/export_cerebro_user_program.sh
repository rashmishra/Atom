...
cd $v_mongo_dir
./mongoexport --host nb-prod-db-cerebro.nbtools.com:27017 --db cerebro -c userProgram -q "$query" --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
