...
v_command="\copy (select * from oms_data.event)  to $v_extract_filename with DELIMITER ',' CSV HEADER"
...
echo -e "\n\nThe PID for Event data export is $v_extract_pid\n\n";
...
echo "Event data export end time is : $taskEndTime "
exit 0