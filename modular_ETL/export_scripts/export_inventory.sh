...
## Script Name: export_inventory.sh
...
v_command="\copy ims.inventory to $v_extract_filename with DELIMITER ',' CSV HEADER"
...
echo -e "\n\nThe PID for inventory data export is $v_extract_pid\n\n";
...
echo "inventory data export end time is : $taskEndTime "
exit 0