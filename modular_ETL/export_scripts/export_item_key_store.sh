...
## Script Name: export_item_key_store.sh
...
export PGPASSWORD='!nv3nt0ry_s3rv1c3'

v_extract_filename="$v_data_dump_dir/$v_data_object.csv";

v_command="\copy ims.item_key_store to $v_extract_filename with DELIMITER ',' CSV HEADER"
...
echo -e "\n\nThe PID for item_key_store data export is $v_extract_pid\n\n";
...
echo "item_key_store data export end time is : $taskEndTime "
exit 0