...
## Script Name: export_merchant_code.sh
...
v_command="\copy ims.merchant_code to $v_extract_filename with DELIMITER ',' CSV HEADER"
...
echo -e "\n\nThe PID for merchant_code data export is $v_extract_pid\n\n";
...
echo "merchant_code data export end time is : $taskEndTime "
exit 0