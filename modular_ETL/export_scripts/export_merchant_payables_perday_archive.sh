...
## Script Name: export_merchant_payables_perday_archive.sh
## Purpose: Modular ETL flow of Atom.

##### $1: Data Object. ####
##### $2: Data dump merchant_payables_perday_archive. ####
...
p_exit_upon_error(){
    ...
    then
        ...
        # Creating new file for merchant_payables_perday_archive's ETL run. Content will be appended in further tasks of T and L.
...
cd $v_mongo_dir
./mongoexport --host 10.2.1.104:27017 --db aps-payable  -c merchant_payables_per_day_archive --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
...
#echo "merchant_payables_perday_archive mongo export end time is : $taskEndTime "
