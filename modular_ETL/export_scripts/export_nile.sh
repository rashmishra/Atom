...
cd $v_mongo_dir
./mongoexport --host 10.2.1.114:27017 --db nile -c transformeddeal --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
