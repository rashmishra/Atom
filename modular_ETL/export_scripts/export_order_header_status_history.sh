...
## Script Name: export_order_header_status_history.sh
...
echo -e "\n\nThe PID for Order Header Status history data export is $v_extract_pid\n\n";
...
echo "Order Header status history data export end time is : $taskEndTime "
exit 0