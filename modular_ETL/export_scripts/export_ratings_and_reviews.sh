...
## Script Name: export_ratings_and_review.sh
...
./mongoexport --host "$v_secondary_ip"  --db nearbuy_ratings_and_reviews -c ratingsAndReview --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
