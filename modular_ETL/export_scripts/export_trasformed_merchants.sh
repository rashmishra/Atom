...
## Script Name: export_transformed_merchants.sh
## Purpose: Modular ETL flow of Atom.

##### $1: Data Object. ####
##### $2: Data dump transformedMerchant. ####
...
p_exit_upon_error(){
    ...
    then
        ...
        # Creating new file for transformedMerchant ETL run. Content will be appended in further tasks of T and L.
...
# ./mongoexport --host 10.2.1.114:27017
./mongoexport --host "$v_secondary_ip" --db nile -c transformedMerchant --out $v_data_dump_dir/$v_data_object.json 2> $v_temp_dir/"$v_data_object"_extract_command_output.txt &
v_extract_pid=$!
...
#echo "transformedMerchant mongo export end time is : $taskEndTime "
