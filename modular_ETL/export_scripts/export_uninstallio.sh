...
## Script Name: export_uninstallio.sh
## Purpose: Modular ETL flow of Atom.

##### $1: Data Object. ####
##### $2: Data dump uninstallio. ####
...
echo "In uninstallio Extract script";
echo $START_DATE
echo $END_DATE
echo $v_expire
...
v_subtask="CSV export";
p_exit_upon_error "$v_task_status" "$v_subtask"

# Zipping the exported data file
gzip -f $v_data_dump_dir/$v_data_object.csv.gz
...
#  Removing the Command's (csvexport) output stored in a file
rm $v_temp_dir/"$v_data_object"_extract_command_output.txt

#echo "uninstallio csv export end time is : $taskEndTime "
