...
v_start_date=$(date --date="-1 days" +%Y-%m-%d)
...
echo "In adwords Loading script";
...
## Place the Google Adwords report names here 
...
do
 ...
 echo "$v_fileName is the filename" 

   schemaFileName=schema_$i.json
   maxBadRecords=0

   tableName="$i"_"$v_tbl_date"
