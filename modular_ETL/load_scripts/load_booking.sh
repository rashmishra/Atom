...
echo "In booking Loading script";
...
#bq query --append=1 --flatten_results=0 --allow_large_results=1 --destination_table=$METADATA_DATASET_NAME.final_booking 'select * from '"$METADATA_DATASET_NAME"'.booking_incremental' > /dev/null
