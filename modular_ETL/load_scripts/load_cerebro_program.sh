...
## Script Name: load_cerebro_program.sh
...
schemaFileName=schema_cerebro_program.json
maxBadRecords=100
...
echo "In program Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for program's ETL run. Content will be appended in further tasks of T and L.
