...
## Script Name: load_cerebro_programresult.sh
...
schemaFileName=schema_cerebro_programresult.json
maxBadRecords=100

v_data_object=$1;
tableName=programresult;
...
echo "In programresult Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for programresult's ETL run. Content will be appended in further tasks of T and L.
