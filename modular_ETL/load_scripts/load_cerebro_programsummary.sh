...
## Script Name: load_cerebro_programsummary.sh
...
schemaFileName=schema_cerebro_programsummary.json
maxBadRecords=100

v_data_object=$1;
tableName=programsummary;
...
echo "In programsummary Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for programsummary's ETL run. Content will be appended in further tasks of T and L.
