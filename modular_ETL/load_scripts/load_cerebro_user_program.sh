...
## Script Name: load_cerebro_user_program.sh
...
schemaFileName=schema_cerebro_user_program.json
maxBadRecords=0
...
echo "In cerebro_user_program Loading script";
...
cd $v_load_dir;
echo "In Load directory, from cerebro_user_program script $v_load_dir";
...
###################################################################################
echo "cerebro_user_program's Load status is: $v_task_status" 
echo $v_task_status > $v_temp_dir/${v_data_object}_load_status.txt
