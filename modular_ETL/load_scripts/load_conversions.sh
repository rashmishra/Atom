...
## Script Name: load_conversions.sh
...
schemaFileName=schema_conversions.json
maxBadRecords=50
...
echo "In conversions Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for conversions's ETL run. Content will be appended in further tasks of T and L.
