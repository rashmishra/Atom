...
## Script Name: load_credit_event_subwallet_mapping.sh
...
schemaFileName=schema_credit_event_subwallet_mapping.json
maxBadRecords=0
...
echo "In credit_event_subwallet_mapping Loading script";
