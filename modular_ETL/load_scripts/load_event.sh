...
schemaFileName=schema_event.json
maxBadRecords=100
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for event's ETL run. Content will be appended in further tasks of T and L.
