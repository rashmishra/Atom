...
schemaFileName=schema_findall.json
maxBadRecords=50
...
echo "In findall Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for findall's ETL run. Content will be appended in further tasks of T and L.
