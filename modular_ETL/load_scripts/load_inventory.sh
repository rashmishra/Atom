...
schemaFileName=schema_inventory.json
maxBadRecords=0
...
echo "In inventory Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for inventory's ETL run. Content will be appended in further tasks of T and L.
