...
## Script Name: load_merchant_code.sh
...
schemaFileName=schema_merchant_code.json
maxBadRecords=0
...
echo "In merchant_code Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for merchant_code's ETL run. Content will be appended in further tasks of T and L.
