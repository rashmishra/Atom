...
## Script Name: load_merchant_payables_perday_archive.sh
...
schemaFileName=schema_merchant_payables_perday_archive.json
maxBadRecords=50
...
echo "In merchant_payables_perday_archive Loading script";
