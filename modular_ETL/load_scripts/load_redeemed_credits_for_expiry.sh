...
## Script Name: load_redeemed_credits_for_expiry.sh
...
schemaFileName=schema_redeemed_credits_for_expiry.json
maxBadRecords=0
...
echo "In redeemed_credits_for_expiry Loading script";
