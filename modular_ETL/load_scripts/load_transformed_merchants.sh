...
## Script Name: load_transfomred_merchants.sh
...
schemaFileName=schema_transformed_merchants.json
maxBadRecords=100
...
echo "In trasnformed merchants Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for transformed merchants ETL run. Content will be appended in further tasks of T and L.
