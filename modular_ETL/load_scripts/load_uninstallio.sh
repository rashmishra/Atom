...
## Script Name: load_uninstallio.sh
...
schemaFileName=schema_uninstallio.json
maxBadRecords=50
...
echo "In Uninstallio Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for uninstallio's ETL run. Content will be appended in further tasks of T and L.
