...
## Script Name: load_user_list_job.sh
...
schemaFileName=schema_user_list_job.json
maxBadRecords=10
...
echo "In user_list_job Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for user_list_job's ETL run. Content will be appended in further tasks of T and L.
