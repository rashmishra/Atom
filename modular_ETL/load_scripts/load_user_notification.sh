...
## Script Name: load_user_notification_offer.sh
...
schemaFileName=schema_user_notification.json
maxBadRecords=0
...
## Loading directly into Atom table instead of incremental load
