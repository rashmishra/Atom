...
## Script Name: load_user_phone_numbers.sh
...
schemaFileName=schema_user_phone_numbers.json
maxBadRecords=0
...
echo "In user_phone_numbers Loading script";
...
v_subtask="Incremental Table load for user_phone_numbers";
p_exit_upon_error "$v_task_status" "$v_subtask"
