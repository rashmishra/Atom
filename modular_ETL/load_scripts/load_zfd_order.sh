...
schemaFileName=schema_zfd_order.json
maxBadRecords=10
...
echo "In zfd order Loading script";
...
p_exit_upon_error(){
    ...
    if [ $v_task_status == "failed" ] ; then
        ...
        # Creating new file for zfd order's ETL run. Content will be appended in further tasks of T and L.
